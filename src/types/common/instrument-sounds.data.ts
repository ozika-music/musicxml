/**
 * Standard MusicXML 4.0 instrument-sound ids.
 *
 * GENERATED FILE — do not edit. Regenerate with:
 *   node scripts/generate-sounds.mjs
 * Source: specs/schema/sounds.xml (894 ids).
 */

/** Every standard instrument-sound id, in catalog order. */
export const INSTRUMENT_SOUND_IDS = [
  'brass.alphorn',
  'brass.alto-horn',
  'brass.baritone-horn',
  'brass.bugle',
...
/** Union of the standard instrument-sound ids (autocomplete-friendly). */
export type InstrumentSoundId = (typeof INSTRUMENT_SOUND_IDS)[number];
